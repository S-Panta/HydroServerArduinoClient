...
int HydroServerMQTTClient::publishObservation(const Observation &observation,
  ...
  // topic construction is of format: “sitecode/deviceid/sensorid/observedproperty
  char topic[256];
  ...
  snprintf(topic, sizeof(topic), "%s/%s/%s/%s", _sitecode,
...
// define a function that you want to do to incoming payload and register to this function as callback
