...
class DataPublisher {
    protected:
        static String createObservationPayload( const Observation& observation, const char* phenomenonTime){
          JsonDocument doc;
    ...
    public: 
        ...
        virtual int publishObservation( const Observation& observation, const char* phenomenonTime); 

        virtual void publishAll(Observation** observations , uint8_t count, const char* phenomenonTime){
