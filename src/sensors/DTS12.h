...
// Default aM!/aD0! response: Temperature, Median Turbidity, Variance, Wipe Status
...
// operating range 0C to +40C (non-freezing), accuracy +/-0.2C
#define DTS12_TEMP_RESOLUTION 2
// Ref: 3.3.1 SDI-12 Measurement Commands aM! results in Temperature, Median Turbidity, Variance and Wipe Status
...
// Variable 1: Median Turbidity
// range 0-1600 NTU; resolution 0.01 NTU;
...
#define DTS12_TURB_DEFAULT_CODE "DTS12turb"

// Variable 2: Variance of Median from Mean
#define DTS12_VARIANCE_RESOLUTION 2
#define DTS12_VARIANCE_VAR_NUM 2
#define DTS12_VARIANCE_VAR_NAME "turbidityVariance"
// the variance unit are always square of variable
#define DTS12_VARIANCE_UNIT_NAME "nephelometricTurbidityUnit"
#define DTS12_VARIANCE_DEFAULT_CODE "DTS12turbvar"


// Variable 3: Wipe Status
...
#define DTS12_WIPE_VAR_NAME "wiperStatus"
...
class DTS12_Temp : public Variable {
 public:
    explicit DTS12_Temp(DTS12* parentSense, const char* uuid = "",
                        const char* varCode = DTS12_TEMP_DEFAULT_CODE): Variable(parentSense, DTS12_TEMP_VAR_NUM, DTS12_TEMP_RESOLUTION,
               DTS12_TEMP_VAR_NAME, DTS12_TEMP_UNIT_NAME, varCode, uuid) {}
    ~DTS12_Temp() override = default;
}; 


class DTS12_Turbidity : public Variable {
 public:
    explicit DTS12_Turbidity(DTS12* parentSense, const char* uuid = "",
                             const char* varCode = DTS12_TURB_DEFAULT_CODE): Variable(parentSense, DTS12_TURB_VAR_NUM, DTS12_TURB_RESOLUTION,
               DTS12_TURB_VAR_NAME, DTS12_TURB_UNIT_NAME, varCode, uuid) {}
    ~DTS12_Turbidity() override = default;
};

class DTS12_Variance : public Variable {
 public:
    explicit DTS12_Variance(DTS12* parentSense, const char* uuid = "",
                            const char* varCode = DTS12_VARIANCE_DEFAULT_CODE): Variable(parentSense, DTS12_VARIANCE_VAR_NUM, DTS12_VARIANCE_RESOLUTION,
...
class DTS12_WipeStatus : public Variable {
 public:
    explicit DTS12_WipeStatus(DTS12* parentSense, const char* uuid = "",
                              const char* varCode = DTS12_WIPE_DEFAULT_CODE): Variable(parentSense, DTS12_WIPE_VAR_NUM, DTS12_WIPE_RESOLUTION,
